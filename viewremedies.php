...
<?php
$count=1;
$sel_query="Select * from remedies ORDER BY id;";
...
<td align="center">
<a href="admineditremedies.php?id=<?php echo $row["id"]; ?>">Edit</a>
</td>
<td align="center">
<a href="admindeleteremedies.php?id=<?php echo $row["id"]; ?>">Delete</a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
